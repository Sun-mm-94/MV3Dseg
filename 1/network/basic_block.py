...
class SparseBasicBlock(spconv.SparseModule):
    ...
    def forward(self, x):
        ...
        aa = self.layers(x)
        return aa.replace_feature(F.leaky_relu(aa.features + identity.features, 0.1))

# class SparseBasicBlock(spconv.SparseModule):
#     def __init__(self, in_channels, out_channels, indice_key):
#         super(SparseBasicBlock, self).__init__()
#         self.layers_in = nn.ModuleList()
#         self.layers_in1 = nn.ModuleList()
#         self.layers_in2 = nn.ModuleList()
#         self.layers_in3 = nn.ModuleList()
#         self.layers_in4 = nn.ModuleList()
#
#         for i in range(2):
#             self.layers_in1.append(spconv.SparseSequential(
#                 spconv.SubMConv3d(in_channels, out_channels, (1, 3, 3), indice_key=indice_key + "bef1", bias=False),
#                 nn.BatchNorm1d(out_channels),
#                 nn.LeakyReLU(0.1)
#             ))
#             self.layers_in2.append(spconv.SparseSequential(
#                 spconv.SubMConv3d(in_channels, out_channels, (3, 1, 3), indice_key=indice_key + "bef2", bias=False),
#                 nn.BatchNorm1d(out_channels),
#                 nn.LeakyReLU(0.1)
#             ))
#             self.layers_in3.append(spconv.SparseSequential(
#                 spconv.SubMConv3d(in_channels, out_channels, (3, 3, 1), indice_key=indice_key + "bef3", bias=False),
#                 nn.BatchNorm1d(out_channels),
#                 nn.LeakyReLU(0.1)
#             ))
#             self.layers_in4.append(spconv.SparseSequential(
#                 spconv.SubMConv3d(in_channels, out_channels, 3, indice_key=indice_key, bias=False),
#                 nn.BatchNorm1d(out_channels),
#                 nn.LeakyReLU(0.1)
#             ))
#             self.layers_in.append(spconv.SparseSequential(
#                 spconv.SubMConv3d(in_channels, out_channels, 1, indice_key=indice_key, bias=False),
#                 nn.BatchNorm1d(out_channels)
#             ))
...
#
#     def forward(self, x):
#         identity = self.layers_in[0](x)
#         identity1 = self.layers_in1[0](x)
#         identity2 = self.layers_in2[0](x)
#         identity3 = self.layers_in3[0](x)
#         identity4 = self.layers_in4[0](x)
#         output = identity1 + identity2 + identity3 + identity4 + identity
#         identity = self.layers_in[1](output)
#         identity1 = self.layers_in1[1](output)
#         identity2 = self.layers_in2[1](output)
#         identity3 = self.layers_in3[1](output)
#         identity4 = self.layers_in4[1](output)
#         output = identity1 + identity2 + identity3 + identity4 + identity
#         return output
